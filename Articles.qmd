...
The article I created from the template can be previewed [here](https://github.com/jennalandy/remodel-your-qmd/blob/master/my_elsevier_article/my_elsevier_article.pdf).
